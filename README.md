...
Помеченные данные: к значению приклеивается ярлык типа, и дальше по нему можно ветвиться. Так собирают диспетчеризацию вручную, до того как в языке появятся классы и интерфейсы.

Нужна курсам, где показывают, что «тип» это не магия компилятора, а всего лишь ещё одно значение рядом с данными.
